...
class ThaidateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testThaidateClass()
    {
        ...
        //$this->assertEquals('พฤ. 14 เม.ย. 59', $Thaidate->strftime('%a %d %b %y', $timestamp));// do not test this since it is deprecated and will be removed. keep this for compare result with `intlDate()` only.
